                ...
                <div class="container text-white">
                    <form class="addform">
                        <div class="form-group ">
                          ...
                          <input type="name" class="form-control" id="memberfirstname" aria-describedby="emailHelp">
                        </div>
                         <div class="form-group">
                          <label for="memberlastname">Last Name</label>
                          <input type="name" class="form-control" id="memberlastname" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="memberphone" aria-describedby="emailHelp">
                         </div>
