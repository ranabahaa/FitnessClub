       ...
       <div class="home" style="height:100vh">
           ...
           <div class="overlay">
                <div class="container middle text-white choose">
                    <a href="<?php echo 'viewMember.php'; ?>" class="chooseMemberModification middle btn btn_inverse cover_cta scroll text-white ">
                        <button class="text-white p-2 px-4 button "> <h3 class="m-1">VIEW</h3></button>
                    </a>
                    <a href="<?php echo 'addmember.php'; ?>" class=" chooseMemberModification middle btn btn_inverse cover_cta scroll text-white ">
                        <button class="text-white p-2 px-4 button "> <h3 class="m-1">ADD</h3></button>
                    </a>
                    <a href="<?php echo 'updatemember.php'; ?>" class=" chooseMemberModification middle btn btn_inverse cover_cta scroll text-white ">
                        <button class="text-white p-2 px-4 button "> <h3 class="m-1">UPDATE</h3></button>
                    </a>
                    <a href="<?php echo 'deletemember.php'; ?>" class=" chooseMemberModification middle btn btn_inverse cover_cta scroll text-white ">
