...
//if(file_exists('../Observer.php'))
  //include ('Observer.php');
require_Once('..//ApplicationLayer/Observer.php');
  //  include('Observer.php');
//if(require('../DataLayer/Database.php'))
...
class Member implements observer{
  ...
  public $id ;
  public $messegeArray =[];
//Update function of member
   /*public function __constructor($mid){
  ...
  {
    $Db = new DataBase(); 
  return $Db ->selectRecord('notification',"Member_Id",$this->member_id);
  }
  /*public function getNotifications()
  {
            return $this->messegeArray;
